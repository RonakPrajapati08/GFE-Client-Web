google.maps.__gjsload__('search_impl', function(_) {
    var gyb = function(a, b) {
            _.H(a.Gg, 3, b)
        },
        kyb = function(a, b, c) {
            const d = _.pJ(new hyb);
            c.Wq = (0, _.Ca)(d.load, d);
            c.clickable = a.get("clickable") != 0;
            _.QYa(c, _.gQ(b));
            const e = [];
            e.push(_.Tj(c, "click", (0, _.Ca)(iyb, null, a)));
            _.Mb(["mouseover", "mouseout", "mousemove"], function(f) {
                e.push(_.Tj(c, f, (0, _.Ca)(jyb, null, a, f)))
            });
        ...
        iyb = function(a, b, c, d, e) {
            ...
            if (e && (f = {
                ...
                const g = _.hi(e.Gg, 3);
                for (let h = 0; h < g; ++h) {
                    const k = _.Yq(e.Gg, 3, _.rQ, h);
                    f.fields[k.getKey()] = k.getValue()
                }
            }
            _.fk(a, "click", b, c, d, f)
        },
        jyb = function(a, b, c, d, e, f, g) {
            let h = null;
            f && (h = {
                title: f[1].title,
                snippet: f[1].snippet
    ...
    lyb.prototype.yF = function(a) {
        if (_.Am[15]) {
            var b = a.Ig;
            const c = a.Ig = a.getMap();
            b && a.Eg && (a.Hg ? (b = b.__gm.Yj, b.set(b.get().Hn(a.Eg))) : a.Eg && _.nZa(a.Eg, b) && (_.Mb(a.Fg || [], _.Vj), a.Fg = null));
            if (c) {
                b = new _.hw;
                ...
                a.get("travelMapRequest") && (b.travelMapRequest = new _.vra(a.get("travelMapRequest")));
                ...
                a.get("gmmContextPipeMetadata") && (b.gmmContextPipeMetadata = new _.Ooa(a.get("gmmContextPipeMetadata")));
                ...
                a.get("airQualityPipeMetadata") && (b.airQualityPipeMetadata = new _.$qa(a.get("airQualityPipeMetadata")));
                a.get("directionsPipeParameters") && (b.directionsPipeParameters =
                    new _.Iz(a.get("directionsPipeParameters")));
                ...
                a.Hg ? (a = c.__gm.Yj, a.set(a.get().El(b))) : kyb(a, c, b);
                _.Ok(c, "Lg");
                _.L(c, 148282)
            }
        }
    };
    _.Li("search_impl", new lyb);
});